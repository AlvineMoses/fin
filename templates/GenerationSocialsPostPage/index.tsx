    ...
    return (
        <Layout>
            <Chat title="Promotional content">
                <Question
                    content="Create promotional content for this post to share on social media with the link: https://www.little.bz/blog/we-are-hiring/ with link and hashtag for Twitter, Facebook"
                    time="Just now"
                />
                <Answer loading />
